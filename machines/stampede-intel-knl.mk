...
CC       = mpicc
F90      = mpif90
CFLAGS   = -O3 -std=c99 -xMIC-AVX512 -diag-disable 161,3180,6843 -I${TACC_HDF5_INC} -I${TACC_GSL_INC}
FFLAGS   = -O3 -fpp -xMIC-AVX512 -diag-disable 3180,6843 -assume byterecl -I${TACC_HDF5_INC}
